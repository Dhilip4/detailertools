...
export const HOLE_DIMENSIONS: Record<BoltDiameter, HoleDimensions> = {
    ...
    "1": { diameter: "1", standard: 1.125, oversized: 1.25, shortSlotWidth: 1.125, shortSlotLength: 1.3125, longSlotWidth: 1.125, longSlotLength: 2.5 },
    "1-1/8": { diameter: "1-1/8", standard: 1.25, oversized: 1.4375, shortSlotWidth: 1.25, shortSlotLength: 1.5, longSlotWidth: 1.25, longSlotLength: 2.8125 },
    "1-1/4": { diameter: "1-1/4", standard: 1.375, oversized: 1.5625, shortSlotWidth: 1.375, shortSlotLength: 1.625, longSlotWidth: 1.375, longSlotLength: 3.125 },
    "1-3/8": { diameter: "1-3/8", standard: 1.5, oversized: 1.6875, shortSlotWidth: 1.5, shortSlotLength: 1.75, longSlotWidth: 1.5, longSlotLength: 3.4375 },
    "1-1/2": { diameter: "1-1/2", standard: 1.625, oversized: 1.8125, shortSlotWidth: 1.625, shortSlotLength: 1.875, longSlotWidth: 1.625, longSlotLength: 3.75 },
};

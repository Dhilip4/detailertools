...
import WeldAccessVisualizer from './WeldAccessVisualizer';
        ...
        <div className="flex flex-col gap-6 animate-fade-in">
            ...
            <div className="flex gap-1 bg-[#111] p-1 rounded-lg border border-gray-800 w-fit">
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded text-sm font-medium transition-all ${activeTab === 'clearance'
                        ? 'bg-[#76b900] text-black shadow-lg'
                        : 'text-gray-400 hover:text-white hover:bg-white/5'
                        }`}
                >
            ...
            <div className="min-h-[500px]">
                ...
                {activeTab === 'clearance' && <WeldAccessVisualizer />}
                {activeTab === 'access' && (
